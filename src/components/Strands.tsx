...
const strands: StrandData[] = [
  {
    ...
    items: [
      ...
      {
        title: "Allow cross entry between men's and women's hostels",
      ...
      {
        title: "Ensure students have a say in rules that govern residential and campus life",
  ...
  },
  {
    ...
    items: [
      { title: "Night access to study spaces", detail: "Students should be able to study when they need to, not only when a rigid timetable permits. Academic life cannot be dignified if access itself is denied." },
      ...
      { title: "Modification of mess timings pursuant to real student schedules", detail: "Students should not lose access to a basic meal due to narrow timings that ignore actual schedules." },
      { title: "Transparency qua financial arrangements and pricing", detail: "Students should know what they are being charged and why. Dignity includes freedom from opaque and arbitrary pricing." },
      { title: "Healthier and more reliable food options", detail: "Students should not have to choose between convenience and decent food. A functioning campus must provide both access and quality." },
      { title: "More printing centres across campus", detail: "Academic work should not be made harder by preventable logistical shortages." },
      { title: "A monthly printing allowance for students", detail: "Printing is tied directly to academic life. Students should not be nickel-and-dimed for ordinary academic needs." },
      ...
      { title: "Introduce golf cart tracking", detail: "Mobility should be predictable on a large campus. Basic movement should not depend on guesswork." },
      { title: "Waive shuttle booking fees", detail: "Campus mobility is a basic necessity, not a premium add-on. Students should not have to pay extra to move within the system they already inhabit." },
    ],
    dark: true,
  },
  {
    ...
    num: "03",
    superText: "Dignity means",
    title: "Health, Fitness, Hygiene, and Recreation Are Real Parts of Student Life",
    ...
    items: [
      ...
      { title: "Move toward 24-hour gym access", detail: "Students have different schedules and pressures. Health should not be made inaccessible through narrow timing rules alone." },
      { title: "More pool tables & table tennis tables in common rooms", detail: "Recreation is part of liveable campus life. Students should have real, not token, access to leisure." },
    ],
    dark: false,
  },
  {
    ...
    items: [
      { title: "Reform the attendance policy", detail: "Attendance should not become a blunt instrument that ignores context, effort, or reality." },
      { title: "Reform improvement and resit exam fee burdens", detail: "Academic recovery should not be made harsher through unnecessary financial punishment." },
    ],
    dark: true,
  },
  {
    ...
    items: [
      ...
      { title: "End counting CRs for quorum while denying power", detail: "Legitimacy cannot be borrowed from representatives who are then sidelined in governance." },
      ...
      { title: "Remove eligibility barriers for leadership positions", detail: "Leadership should be broadly open, not carefully filtered through narrow academic, programme, or pedigree-based restrictions." },
